 ...
 * @version $Rev: 385 $ - $Date: 2010-03-23 10:54:45 +0100 (Di, 23 Mrz 2010) $
 */
public abstract class AbstractTinyTimTestCase extends TestCase {
    ...
    public AbstractTinyTimTestCase() {
        super();
    }

    public AbstractTinyTimTestCase(String name) {
        super(name);
    }
